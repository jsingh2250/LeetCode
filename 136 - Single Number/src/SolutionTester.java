...
public class SolutionTester {
        ...
        public static void main(String[] args) throws Exception {
                ...
                testCases.add(new TestCase(new int[] { 2, 2, 1 }));
                testCases.add(new TestCase(new int[] { 4, 1, 2, 1, 2 }));
                testCases.add(new TestCase(new int[] { 1 }));
                ...
                for (TestCase testCase : testCases) {
                        ...
                        System.out.println("The output of the solution is: "
                                        + solution.singleNumber(testCase.getNums()));
